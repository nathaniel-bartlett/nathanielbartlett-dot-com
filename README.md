...
* When a play box in the discography section is clicked, the audio file will load and play. Each dot represents 10s, and as the file plays, the dots lose their opacity in proportion to the passage of time. Click on a dot and the audio file will skip to that location in time.
...
* The 45 degree angle is a nice contrast to all the horizontal and vertical elements.
...
* If you have scrolled down so the top of the box is above the top of the screen, clicking the toggle bar will collapse the box *and* bring the top of the text box right to where you clicked.
...
* The SVG text logo scales to either 100% vertical or horizontal, depending on the screen dimensions.
